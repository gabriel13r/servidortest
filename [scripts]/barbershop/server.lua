...
vRPbs = {}
Tunnel.bindInterface("barbershop",vRPbs)
Proxy.addInterface("barbershop",vRPbs)
BSclient = Tunnel.getInterface("barbershop")

local cfg = module("barbershop","cfg/barbershop")
