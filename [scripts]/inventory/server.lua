...
vRPN = {}
Tunnel.bindInterface('inventory', vRPN)
Proxy.addInterface('inventory', vRPN)
vRPCclient = Tunnel.getInterface('inventory')
...
function vRPN.Inventory()
    ...
    if user_id then
        ...
        if data and data.inventory then
            ...
            local emptySlots = fixedSlot - usedSlots

            return inventory, vRP.getInventoryWeight(user_id), vRP.getInventoryMaxWeight(user_id), emptySlots, 0
        end
    end
end
