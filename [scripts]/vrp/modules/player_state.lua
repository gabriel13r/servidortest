...
-- FINALIZAR
-----------------------------------------------------------------------------------------------------------------------------------------
function tvRP.removeFinalizado()
	local user_id = vRP.getUserId(source)
	if user_id then
		vRP.query("teste/delete_users_finalizado", { idUserFinalizado = user_id })
	end
end

function tvRP.removeSemPulso()
	local user_id = vRP.getUserId(source)
	if user_id then
		vRP.del_sempulso(user_id)
	end
end
...
AddEventHandler("vRP:playerSpawn", function(user_id, source, first_spawn)
	...
	TriggerEvent("reloadtattos", user_id)
	TriggerEvent("forcereloadtattos", user_id)
end)
