...
function vRP.setHunger(user_id,value)
  ...
  if data then
      ...
      TriggerClientEvent("statusHunger", source, 100 - data.hunger)
  end
end
...
function vRP.setThirst(user_id,value)
  ...
  if data then
      ...
      local source = vRP.getUserSource(user_id)
      TriggerClientEvent("statusThirst", source, 100 - data.thirst)
  end
end
...
foodSystem = {
  active = true,
  eventHunger = "statusHunger",
  eventThrist = "statusThirst"
}