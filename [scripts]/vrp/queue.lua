...
function Queue:AddToQueue(ids, connectTime, name, src, deferrals)
	...
	local tmp = { source = src, ids = ids, name = name, firstconnect = connectTime,
		priority = self:IsPriority(ids) or (src == "debug" and math.random(0, 15)), timeout = 0, deferrals = deferrals }
	...
	local function playerConnect(name, setKickReason, deferrals)
		...
		Citizen.CreateThread(function()
			...
			while true do
				...
				local msg = string_format("OSTI VILLE\n\n" ..
					Config.Language.pos ..
