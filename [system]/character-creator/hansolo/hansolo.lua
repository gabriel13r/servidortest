...
function refreshDefaultCharacter()
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
		...
		SetPedComponentVariation(PlayerPedId(), 6, 59, 0, 2)
		SetPedComponentVariation(PlayerPedId(), 11, 461, 0, 2) --jaqueta
		...
		SetPedComponentVariation(PlayerPedId(), 6, 60, 0, 2)
		SetPedComponentVariation(PlayerPedId(), 11, 212, 1, 2)
		SetPedComponentVariation(PlayerPedId(), 9, -1, 0, 2)
		SetPedComponentVariation(PlayerPedId(), 10, -1, 0, 2)
		SetPedPropIndex(PlayerPedId(), 2, -1, 0, 2)
		SetPedPropIndex(PlayerPedId(), 6, -1, 0, 2)
...
RegisterNUICallback('cDoneSave', function(data, cb)
	...
	SetEntityCoordsNoOffset(PlayerPedId(), config.spawnCoord[1], config.spawnCoord[2], config.spawnCoord[3], true, true,
		true)
