...
zCLIENT = {}
Tunnel.bindInterface('multi_character', zCLIENT)
zSERVER = Tunnel.getInterface('multi_character')
...
function zCLIENT.spawnChar(user_id)
    ...
    if not spawned then
        ...
        Wait(1800)
        SetCamCoord(cam, 560.01,-436.53,-69.66 + 0.52)
        SetCamRot(cam,0.0,0.0,193.55,2)
        SetFocusEntity(PlayerPedId())
        SetEntityCoordsNoOffset(PlayerPedId(),560.68, -438.69, -69.64, true, true, true)
        SetEntityHeading(PlayerPedId(), f(19.03))
...
AddEventHandler('chars:setupChar', function()
    ...
    SetEntityCoordsNoOffset(PlayerPedId(), 559.5,-440.2,-70.66, true, true, true)
    SetEntityHeading(PlayerPedId(), f(19.03))
    cam = CreateCamWithParams('DEFAULT_SCRIPTED_CAMERA', 559.5,-440.2,-70.66 + 200.0, 175.9, 180.0, 170.0, 75.0,
        false, 0)
